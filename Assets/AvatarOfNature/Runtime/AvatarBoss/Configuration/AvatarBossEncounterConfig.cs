...
namespace Unity.FPS.AvatarBoss
{
    ...
    public sealed class AvatarBossEncounterConfig : ConfigContainer<AvatarBossDifficultyProfile>
    {
        ...
        public static AvatarBossDifficultyProfile CreateEasy()
        {
            ...
            profile.HealPercent = 0.03f; profile.SummonCount = 2; profile.SummonCooldownMultiplier = 1.2f; profile.SummonHealthMultiplier = 0.6f; profile.SummonDamageMultiplier = 0.45f; profile.SummonAttackCooldownMultiplier = 1.5f; profile.ComboFrequency = 0.55f;
            ...
            profile.SectorRegenerationDelay = 42f; profile.HealthPickupCooldown = 34f; profile.MaxActiveHealthPickups = 1; profile.HealthPickupHealAmount = 45f;
            profile.BossKnockbackEnabled = false; profile.SummonsEnabled = false;
        ...
        public static AvatarBossDifficultyProfile CreateNormal()
        {
            ...
            profile.ShockwaveSpeedMultiplier = 1f; profile.MeteorDamage = 20f; profile.OrbCount = 3; profile.OrbHealth = 30f; profile.OrbSpeed = 4.5f; profile.HealPercent = 0.04f;
            ...
            profile.SectorRegenerationDelay = 28f; profile.HealthPickupCooldown = 25f; profile.MaxActiveHealthPickups = 1; profile.HealthPickupHealAmount = 40f;
            profile.BossKnockbackEnabled = true; profile.SummonsEnabled = false;
        ...
        public static AvatarBossDifficultyProfile CreateHard()
        {
            ...
            profile.ShockwaveSpeedMultiplier = 1.1f; profile.MeteorDamage = 24f; profile.OrbCount = 4; profile.OrbHealth = 42f; profile.OrbSpeed = 5.75f; profile.HealPercent = 0.06f;
            ...
            profile.SectorRegenerationDelay = 16f; profile.HealthPickupCooldown = 18f; profile.MaxActiveHealthPickups = 2; profile.HealthPickupHealAmount = 35f;
            profile.BossKnockbackEnabled = true; profile.SummonsEnabled = true;
